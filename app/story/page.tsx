...
export default function StoryPage() {
  return (
    <div className="bg-gray-50">
      ...
      >
        <div className="text-3xl md:text-4xl font-extrabold text-gray-700 leading-tight mb-5 text-center">
          <h1>Our Story</h1>
        </div>
        {/* Background Texture */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(235,109,58,0.18),transparent_45%),radial-gradient(circle_at_80%_70%,rgba(15,118,110,0.18),transparent_45%)]"></div>

        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          {/* Image */}
          <div className="lg:col-span-7 relative">
            <div className="absolute -top-10 -left-10 w-48 h-48 bg-[#EB6D3A]/30 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-[#0f766e]/30 rounded-full blur-3xl"></div>

            <Image
              src="/images/logo/16-years.jpg"
              alt="16 Years of Purpose & Progress"
              width={1600}
              height={600}
              priority
        ...
        "
            >
              {/* Accent Line */}
              <div className="absolute left-0 top-10 h-24 w-[4px] bg-[#EB6D3A] rounded-full"></div>

              <h2 className="text-3xl md:text-4xl font-extrabold text-[#0f766e] leading-tight mb-5">
                16 Years of Purpose <br /> & Progress
              </h2>

              <p className="text-gray-800 text-lg leading-relaxed">
                For over sixteen years, Foundation Fighting Poverty has stood
                beside vulnerable communities empowering lives, responding to
                crises, and building sustainable pathways out of poverty across
                Pakistan.
              </p>
            </div>
          </div>
...
<section
  id="awards"
  className="relative w-full py-24 bg-[#fdff985d]"
>
  {/* Optional subtle texture */}
  <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(235,109,58,0.06),transparent_40%),radial-gradient(circle_at_70%_80%,rgba(235,109,58,0.04),transparent_40%)]"></div>
  ...
  <div className="relative max-w-7xl mx-auto px-6">
    ...
    <div className="flex gap-8 overflow-x-auto scrollbar-thin scrollbar-thumb-[#EB6D3A]/70 scrollbar-track-gray-200 pb-6">
      {[
        ...
        >
          {/* Award Image */}
          <div className="w-32 h-32 mx-auto rounded-full bg-[#EB6D3A] p-[3px]">
      ...
      >
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12 text-lg">
          Recognitions and certifications that highlight our commitment to
        ...
        <div className="grid grid-rows-2 grid-flow-col gap-8 overflow-x-auto pb-6 scrollbar-thin scrollbar-thumb-[#009688]/70 scrollbar-track-gray-200">
          {[
            ...
            >
              {/* Top Gradient Bar */}
              <div className="absolute top-0 left-0 w-full h-1.5 rounded-t-2xl bg-[#EB6D3A]" />
      ...
      {/*  Heroes Section */}
      <section id="heroes" className="bg-slate-400 py-20 relative">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-extrabold text-center bg-white bg-clip-text text-transparent mb-6">
            Our Heroes
          </h2>
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12 text-lg">
          ...
          <div className="flex gap-6 overflow-x-auto scrollbar-thin scrollbar-thumb-[#EB6D3A]/70 scrollbar-track-gray-200 pb-4">
            {[
              ...
              <div
                key={index}
                className="min-w-[220px] bg-amber-100 rounded-2xl p-6 text-center shadow-md hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300"
              >
                {/* Hero Image with Glow Border */}
                <div className="relative mx-auto w-32 h-32">
                  <div className="absolute inset-0 rounded-full bg-[#EB6D3A] p-[3px]">
                    <Image
                      src={hero.image}
                      alt={hero.name}
                      width={200}
